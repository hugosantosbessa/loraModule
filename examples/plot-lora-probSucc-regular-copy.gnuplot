...
set output '~/ns-3/TestResult/probSuccessRegular.pdf'
set key bottom

set multiplot

# Filename of the data
filename1='~/ns-3/TestResult/test0/traffic-60/result-regular-STAs.dat.dat'


# Plot the data
plot filename1 using 1:3 w lp lw 4 t 'Regular'
